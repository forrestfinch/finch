...
const navigation = [
    {
        name: 'Mail',
        href: 'mailto:support@finch.com.ng',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
            <svg className="w-6 h-6" fill="none" {...props} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
        ),
    },
    {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/company/forrestfinch',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
    ...
    {
        name: 'Instagram',
        href: 'https://www.instagram.com/forrestfinch',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
    ...
    {
        name: 'Twitter',
        href: 'https://twitter.com/forrestfinch',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
            <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                <path
                    fillRule="evenodd"
